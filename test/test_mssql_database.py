...
def test_when_using_sql_auth_ask_credentials_should_return_connection_str_with_uid_and_pw(
    mssql_db: MSSQLDatabase, mssql_config: dict[str, str | int]
):
...
def test_when_using_win_auth_ask_credentials_should_return_connection_str_with_trusted_connection() -> (
    None
):  # mssql_db: MSSQLDatabase, mssql_config: dict[str, str | int]):
    server = "localhost"
    port = 1433
...
class TestWithSQLServer:
    ...
    def test_close_should_succeed_with_open_connection(
    ...
    def test_get_databases_should_return_list_of_database_names(
        self, connected_db: MSSQLDatabase
    ):
    ...
    def test_get_databases_should_not_return_system_databases(
        self, connected_db: MSSQLDatabase
    ):
        databases = connected_db.get_databases()
    ...
    def test_get_schemas_should_return_list_of_schemas(
        self, connected_db: MSSQLDatabase
    ):
    ...
    def test_get_objects_should_return_list_of_dicts_of_objects_and_their_types(
        self, connected_db: MSSQLDatabase
    ):
    ...
    def test_get_schema_description_should_return_extended_property_description(
        self, connected_db: MSSQLDatabase
    ):
        desc = connected_db.get_schema_description(schema="store")
        assert desc == "Schema to store records."  # katso kuvaus filuista?

    def test_get_schema_description_should_return_empty_string_if_no_extended_property(
        self, connected_db: MSSQLDatabase
    ):
        desc = connected_db.get_schema_description(schema="report")
        assert desc == ""

    def test_get_object_description_should_return_extended_property_description(
        self, connected_db: MSSQLDatabase
    ):
    ...
    def test_get_object_description_should_return_empty_string_if_no_such_object(
        self, connected_db: MSSQLDatabase
    ):
        desc = connected_db.get_object_description(
    ...
    def test_get_available_extended_properties_should_return_list_of_extended_properties(
        self, connected_db: MSSQLDatabase
    ):
    ...
    def test_get_available_extended_properties_should_return_empty_list_if_no_such_object(
        self, connected_db: MSSQLDatabase
    ):
        extended_properties = connected_db.get_available_extended_properties(
    ...
    def test_get_object_columns_should_return_list_of_dicts_of_columns(
        ...
        assert cols[0] == {
            ...
            "Primary Key": "x",
            "Foreign Key": "",
            "Description": "Client ID or client number.",
            "Flag": "",
        }
    ...
    def test_get_object_indexes_should_return_list_of_dicts_of_indexes(
        ...
        assert indexes[0] == {
            "Index Name": "Clients_NonClusteredIndex",
            "Index Type": "NONCLUSTERED",
            "Is Unique": "Yes",
            "Index Columns": [
                {"column_name": "name", "column_sort_order": "(ascending)"},
                {"column_name": "date_of_birth", "column_sort_order": "(ascending)"},
            ],
        }

    def test_get_object_indexes_should_return_empty_list_if_no_such_object(
        self, connected_db: MSSQLDatabase
    ):
        indexes = connected_db.get_object_indexes("store", "no_such_object")
        assert indexes == []

    def test_get_object_parameters_should_return_list_of_dicts_of_indexes(
        self, connected_db: MSSQLDatabase
    ):
    ...
    def test_get_object_parameters_should_return_empty_list_if_no_such_object(
        self, connected_db: MSSQLDatabase
    ):
    ...
    @pytest.mark.skip(
        reason="Outdated test with wrong number of params for get_object_dependencies, needs to be updated"
    )
    def test_get_object_dependencies_should_return_list_of_dicts_of_indexes(
        self, connected_db: MSSQLDatabase
    ):
    ...
    def test_get_object_dependencies_should_return_empty_list_if_no_such_object(
        self, connected_db: MSSQLDatabase
    ):
        deps = connected_db.get_object_dependencies(
            "store", "no_such_object", [TEST_DB_NAME]
        )
        assert deps == []
    ...
    def test_get_object_dependencies_should_return_empty_list_if_no_dependencies(
        self, connected_db: MSSQLDatabase
    ):
